...
export function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-[var(--border)]">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 px-5 py-14 md:px-8 md:py-20 lg:grid-cols-[.96fr_1.04fr] lg:items-center">
        <div>
          ...
          <h1 className="font-display mt-6 max-w-3xl text-[clamp(3rem,6.6vw,6.25rem)] font-extrabold leading-[.91] tracking-[-.065em] text-balance">
            Reclama ta.{" "}
          ...
          <div className="mt-8 grid max-w-2xl gap-3 sm:grid-cols-3">
            {[
              ...
              return (
                <div
                  key={String(label)}
                  className="flex items-center gap-2.5 rounded-2xl border border-[var(--border)] bg-white/55 px-4 py-3 text-sm font-extrabold backdrop-blur"
                >
                  <I className="size-4 text-[var(--route)]" />
                  {String(label)}
                </div>
              );
            })}
        ...
        <div className="relative">
          ...
          <MediaFrame
            ...
            className="relative aspect-[4/5] min-h-[500px] rounded-[2.4rem] border border-[var(--border)] shadow-[0_35px_120px_rgba(31,24,48,.18)] md:aspect-[5/4] lg:aspect-[4/5]"
          />

          <div className="absolute -bottom-5 left-4 right-4 grid grid-cols-[auto_1fr] items-center gap-4 rounded-3xl border border-white/20 bg-[color:rgb(31_24_48_/_0.92)] p-4 text-white shadow-2xl backdrop-blur md:left-6 md:right-6">
